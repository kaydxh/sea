...
import (
	...
	"github.com/kaydxh/sea/pkg/sea-date/infrastructure/database/dao"
	"github.com/kaydxh/sea/pkg/sea-date/infrastructure/database/model"
)
...
func (d *TaskDao) AddTask(ctx context.Context, arg *model.Task) error {
	...
	_, err := mysql_.ExecContext(ctx, query, arg, nil, d.db)
	return err
}
